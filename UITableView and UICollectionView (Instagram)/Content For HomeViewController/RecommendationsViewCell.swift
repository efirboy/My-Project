...
final class RecommendationsViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        addRecommendationPhoto(image: jotaPhoto, named: "Jota", labelLogin: jotaLabel, textLogin: "diogoj_18", forYouLabel: forYouLabelJota, button: buttonJota, position: 0)
        addRecommendationPhoto(image: yamalPhoto, named: "Yamal", labelLogin: yamalLabel, textLogin: "lamineyamal", forYouLabel: forYouLabelYamal, button: buttonYamal, position: 1)
        addRecommendationPhoto(image: hollandPhoto, named: "Holland", labelLogin: hollandLabel, textLogin: "erling", forYouLabel: forYouLabelHolland, button: buttonHolland, position: 2)
    }
