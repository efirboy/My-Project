...
final class StorysScrollTableViewCell: UITableViewCell {
    ...
    // Функция добавления изображения (истории) и никнейма
    func addImage(storysImage: UIImageView, image: UIImage, x: CGFloat, nicknameLabel: UILabel, nickname: String, storysInactive: Bool) {
    ...
    // По нажатию на сторис меняем цвет градиента на серый
